...
function Navbar() {
  ...
  return (
    <nav className="  flex w-full overflow-x-hidden justify-left items-center px-6 py-4 border-b-2 border-amber-500 bg-gradient-to-r from-amber-400 to-amber-500 shadow-lg">
